...
void updateHighScore(int score) {
  // Read current high score from EEPROM
  highscore = EEPROM.get(50, highscore);
  if (score > highscore) {
    highscore = score;
    EEPROM.put(50, score);
    Serial.print(F("New Highscore Saved: "));
...
void setup() {
  ...
  // display.clearDisplay();
  // Serial.begin(9600);
  EEPROM.get(50, highscore); 
  Serial.print(F("Highscore Loaded: "));
  Serial.println(highscore);
